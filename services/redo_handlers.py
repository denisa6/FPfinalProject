...
def add_grade_handler(grade_book_service, discipline_id, student_id, grade_value):
    grade_book_service.add_grade(discipline_id, student_id, grade_value)
...
def update_student_information_handler(student_service, student_id, new_student_name, old_student_name):
    student_service.update_student_information(student_id, new_student_name)


def update_discipline_information_handler(discipline_service, discipline_id, new_discipline_name, old_discipline_name):
    discipline_service.update_discipline_information(discipline_id, new_discipline_name)
